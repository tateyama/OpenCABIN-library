...
//#define OCL_MULTICAST_NETDEV "10.1.0.10" // multicast network device address (2 or more network devices)
...
#define OCL_VIEWPORT_LEFT_X 137
#define OCL_VIEWPORT_LEFT_Y 9
#define OCL_VIEWPORT_LEFT_WIDTH 750
#define OCL_VIEWPORT_LEFT_HEIGHT 750

#define OCL_VIEWPORT_RIGHT_X OCL_VIEWPORT_LEFT_X 
#define OCL_VIEWPORT_RIGHT_Y OCL_VIEWPORT_LEFT_Y
#define OCL_VIEWPORT_RIGHT_WIDTH OCL_VIEWPORT_LEFT_WIDTH
#define OCL_VIEWPORT_RIGHT_HEIGHT OCL_VIEWPORT_LEFT_HEIGHT

#define OCL_FRONT_WIDTH 2.5
#define OCL_FRONT_HEIGHT 2.5
#define OCL_LEFT_WIDTH 2.5
#define OCL_BOTTOM_HEIGHT OCL_FRONT_HEIGHT
#define OCL_FRONT_ORG_DIST_DEPTH 1.25
#define OCL_FRONT_ORG_DIST_LEFT 1.25
